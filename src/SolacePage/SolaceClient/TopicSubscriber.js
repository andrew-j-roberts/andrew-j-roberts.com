...
export const TopicSubscriber = (solaceModule, topicName, setMessage) => {
  ...
  subscriber.connect = function (hostUrl, vpnName, userName, password) {
      ...
      subscriber.session.on(SessionEventCode.CONNECT_FAILED_ERROR, function (sessionEvent) {
          subscriber.log('Connection failed to the message router: ' + sessionEvent.infoStr +
              ' - check correct parameter values and connectivity!');
      });
      subscriber.session.on(SessionEventCode.DISCONNECTED, function (sessionEvent) {
      ...
      subscriber.session.on(SessionEventCode.SUBSCRIPTION_ERROR, function (sessionEvent) {
          subscriber.log('Cannot subscribe to topic: ' + sessionEvent.correlationKey);
      });
      subscriber.session.on(SessionEventCode.SUBSCRIPTION_OK, function (sessionEvent) {
